...
export const features: Feature[] = [
  {
    ...
    capabilities: [
      { icon: 'ghost', heading: 'Per-brand widget', body: 'Own colors, greeting and topics per product. Customers never see another brand.' },
      ...
      { icon: 'mail', heading: 'Per-brand email branding', body: 'Transcripts, CSAT and follow-ups go out branded as the right product.' },
      { icon: 'layers', heading: 'One login, one bill', body: 'Switch products from the workspace picker. No re-login, no stacked invoices.' },
    ],
    bulletsHeading: 'Built for founders juggling products',
    bullets: [
      'Switch brands from the workspace picker, no re-login',
      'One notification stream across every product',
  ...
  },
  {
    ...
    lead: 'A real analytics suite, not a vanity dashboard. Response times, CSAT, channel mix, top countries and a live view of where support is strong and where it slips.',
    overviewBlurb: 'Response time, CSAT, heatmaps, channel mix, top countries and an agent leaderboard.',
    sectionHeading: 'Measure what good support looks like.',
    sectionLead: 'Enough insight to run support well, without a data team.',
    capabilities: [
      { icon: 'bar-chart', heading: 'Response and resolution', body: 'Median and SLA response times, by brand, channel and country.' },
  ...
  },
  {
    ...
    capabilities: [
      ...
      { icon: 'layers', heading: 'Every brand', body: 'Switch between products from the same app.' },
    ],
  ...
  },
  {
    ...
    lead: 'A public REST API, webhooks, and an MCP server that turns your conversations into tools for Claude or any agent you build. On every plan, even Free.',
    visual: 'mcp',
    overviewBlurb: 'A public REST API, webhooks, and an MCP server on every plan. Pipe support into Claude or your agents.',
    sectionHeading: 'Built for people who live in the terminal.',
    sectionLead: 'The support tool that fits your workflow, instead of making you leave it.',
    capabilities: [
      ...
      { icon: 'sparkles', heading: 'MCP server', body: 'Expose your inbox as tools so Claude can read and answer conversations.' },
    ...
    bullets: [
      'Summarize unanswered conversations across all brands from Claude',
